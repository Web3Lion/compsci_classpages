...
(function () {
  var ICONS = {
    ...
    globe:     '<circle cx="12" cy="12" r="9" style="stroke:var(--accent)" stroke-width="1.6"/><path d="M3 12h18M12 3a14 14 0 010 18M12 3a14 14 0 000 18" style="stroke:var(--accent)" stroke-width="1.4"/>',
