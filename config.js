...
/* ============================================================
   ...
   ============================================================ */
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m1a","module":1,"title":"Blockchain Foundations","category":"Blockchain Basics","levels":[{"difficulty":"Easy","points":50,"hint":"Blocks linked in a chain.","prompt":"Objective — Blockchain fundamentals. A shared, append-only ledger of transactions stored in linked blocks is called a ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"7937ea509b73d988b162e6ab3afd5a3e4a1b8c0a3cc773aae6f16b6564233e44"},{"difficulty":"Medium","points":100,"hint":"No single point of control.","prompt":"Objective — Decentralization. A network with no single central authority, where copies of the ledger are spread across many nodes, is ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"4f15cbe9facaa2c22ded8ffe4f5fd812f5d05a3163faa851b4e3409d2316550c"},{"difficulty":"Hard","points":150,"hint":"Cannot be changed after the fact.","prompt":"Objective — Blockchain fundamentals. Once data is confirmed on the chain it cannot be altered. This property is called ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"c49b5deed9c8d7547e3b7ce3d4507f6eb826c1faf33c328f87131a1709cc1fbf"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m1b","module":1,"title":"Consensus & Hashing","category":"Blockchain Basics","levels":[{"difficulty":"Easy","points":50,"hint":"One computer on the network.","prompt":"Objective — Blockchain fundamentals. A single computer that stores a copy of the blockchain and helps validate it is called a ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"451140ce83d260df5dfb991be747dc58ab9dd8ec4f1ee1271b5eabba10dacb1a"},{"difficulty":"Medium","points":100,"hint":"A fixed-length fingerprint.","prompt":"Objective — Cryptography & hashing. A one-way function that turns any input into a fixed-length fingerprint, linking each block to the last, produces a ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"deaed1f0d22fe5f2c4aa644d8fa1a50028d36f4e36358e9ea9545ec274adaa4e"},{"difficulty":"Hard","points":150,"hint":"Miners race to solve a puzzle.","prompt":"Objective — Consensus mechanisms. The consensus mechanism where miners expend computing power to solve a puzzle and add the next block is called ___ ___ ___.\n\nSubmit as flag{three words} (lowercase).","flagHash":"7978f248a7b9741dd3d1db7281e85671319f62428f305fa0bfb8118aa7107c12"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m2a","module":4,"title":"Keys & Wallets","category":"Digital Wallets","levels":[{"difficulty":"Easy","points":50,"hint":"Holds your keys.","prompt":"Objective — Wallet types. The software or device that stores your keys and lets you send and receive crypto is a ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"ebcaa50801688ebe0fc816606329c54551cd6d9679cef3cf4b69abb211bbec4d"},{"difficulty":"Medium","points":100,"hint":"The secret half of your keypair. Whoever holds it controls the funds. Two words.","prompt":"Objective — Public & private keys. The secret that proves ownership and must NEVER be shared is your ___ ___.\n\nSubmit as flag{two words} (lowercase).","flagHash":"74f61448a78aabf20bcda00e7818038e2de0d52213de30704ce7986d5357e0ee"},{"difficulty":"Hard","points":150,"hint":"The human-readable backup that can regenerate your entire wallet — usually 12 or 24 ordinary words in a fixed order. Two words.","prompt":"Objective — Wallet recovery. The list of 12–24 words that can restore an entire wallet is called the ___ ___.\n\nSubmit as flag{two words} (lowercase).","flagHash":"85900643d4625310d3837231ee08873598aa12556521c7ecbffb35c150728cff"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m2b","module":4,"title":"Custody & Addresses","category":"Digital Wallets","levels":[{"difficulty":"Easy","points":50,"hint":"Share this to receive funds.","prompt":"Objective — Wallet transactions. The public string you share so others can send you crypto is your ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"53631335bc552a01ecab2938272fec7e45811fc2432f18c8c117a99ef671534f"},{"difficulty":"Medium","points":100,"hint":"Keys kept entirely offline, out of reach of remote attackers. Two words.","prompt":"Objective — Wallet types. A wallet kept offline for maximum security is called a ___ ___.\n\nSubmit as flag{two words} (lowercase).","flagHash":"39863d225ef7f8c85a3e7e6ffed56f48ea5f5258b4bcdc7dd3ed641ae3ce71ed"},{"difficulty":"Hard","points":150,"hint":"Derived from the private key.","prompt":"Objective — Public & private keys. The key derived from your private key that others use to verify your signatures is your ___ ___.\n\nSubmit as flag{two words} (lowercase).","flagHash":"849913b08cbe7bcead3b745de10e0f6b59a19482dd7568299243304ccc68371a"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m3a","module":2,"title":"Coins & Tokens","category":"Cryptocurrencies","levels":[{"difficulty":"Easy","points":50,"hint":"A unit of value on a chain.","prompt":"Objective — Coins & tokens. A digital asset created and managed on an existing blockchain is called a ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"777343ab04f23add13eab005e5d5f438311c8b873ae7179d0f050845a9715990"},{"difficulty":"Medium","points":100,"hint":"The fee to run a transaction.","prompt":"Objective — Gas fees. The fee paid to run a transaction or contract on Ethereum is called ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"77f8178a7fda468b8f3d105b49c4327131ab5eded25f835562d4ee29a83ea0d9"},{"difficulty":"Hard","points":150,"hint":"Pegged to a stable value.","prompt":"Objective — Coins & tokens. A token designed to hold a steady value by pegging to an asset like the US dollar is a ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"93219be3db5581f65057ddc74bc12beec724d6908d6943a8f0f1b75e752b7d15"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m3b","module":2,"title":"Standards & Value","category":"Cryptocurrencies","levels":[{"difficulty":"Easy","points":50,"hint":"Interchangeable, like dollars.","prompt":"Objective — Tokenomics. A token where every unit is identical and interchangeable is called ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"28abd36ff7b1b8293fa3d3ac6310575b940c179254176049533897588d1e9a4b"},{"difficulty":"Medium","points":100,"hint":"Digital money on a chain.","prompt":"Objective — Coins & tokens. A digital currency secured by cryptography and running on a blockchain is a ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"40c7e1eaa60e4338bf0193372af2082ab3927a61013bb68afd85ac9f2d8ab00a"},{"difficulty":"Hard","points":150,"hint":"Ethereum fungible-token standard.","prompt":"Objective — Tokenomics. The Ethereum standard that defines how fungible tokens behave is ___.\n\nSubmit as flag{standard} (lowercase, keep the hyphen).","flagHash":"3aacebec9f504e2ad270d881e8f3359b7afa3c33755bcf6eeab4e26aa1b67b76"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m4a","module":3,"title":"What Is an NFT?","category":"NFTs","levels":[{"difficulty":"Easy","points":50,"hint":"Three letters. The token is one of a kind — you can't swap it for another.","prompt":"Objective — NFT fundamentals. A one-of-a-kind token that proves ownership of a unique digital item is abbreviated ___.\n\nSubmit as flag{abbreviation} (lowercase).","flagHash":"036644b3363b146e712afd7ead72b4287247582b0f81175bd1320ed38a3cdcdd"},{"difficulty":"Medium","points":100,"hint":"Each token is unique and can't be swapped one-for-one with another. Hyphenated.","prompt":"Objective — NFT characteristics. A token that is unique and cannot be swapped one-for-one with another is ___.\n\nSubmit as flag{word} (lowercase, keep the hyphen).","flagHash":"ca18db12688eb6c70b4c0f7b53c10cd3346be7f47c782e6c13e5d6aba231582e"},{"difficulty":"Hard","points":150,"hint":"Creating the token on-chain.","prompt":"Objective — Creating an NFT. The process of publishing a new NFT onto the blockchain is called ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"4a373afdb00259be10b46fc1938c504d00a29def769bce8e9561a2a59d6ae42a"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m4b","module":3,"title":"Ownership & Metadata","category":"NFTs","levels":[{"difficulty":"Easy","points":50,"hint":"The NFT proves this.","prompt":"Objective — NFT characteristics. An NFT recorded on-chain provides verifiable proof of ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"d1e610099b17a5b008e801609d52f09d63d7f7a600bc1fe6c0666aa991b578a2"},{"difficulty":"Medium","points":100,"hint":"Data describing the asset.","prompt":"Objective — NFT metadata. The information describing an NFT — its name, traits, and image link — is called ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"951adea39b54dd0ebb4028b560b787f549cddb92c4c371855307423c2a2db29f"},{"difficulty":"Hard","points":150,"hint":"Distributed file storage.","prompt":"Objective — NFT metadata. The distributed file system often used to store NFT media off-chain is abbreviated ___.\n\nSubmit as flag{abbreviation} (lowercase).","flagHash":"c14bd5913924191c2a64a25fac8c71abd85279d2fd89208757864e1e64fd85f0"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m5a","module":5,"title":"Smart Contracts","category":"Blockchain Coding","levels":[{"difficulty":"Easy","points":50,"hint":"Self-executing code on-chain.","prompt":"Objective — Smart contracts. Self-executing code stored on the blockchain that runs when conditions are met is a ___ ___.\n\nSubmit as flag{two words} (lowercase).","flagHash":"497a532123f0646fd636ac062b314d6d8ebb1119ad6daf013886f8ebe6895129"},{"difficulty":"Medium","points":100,"hint":"Ethereum's main language.","prompt":"Objective — Creating a token. The primary programming language for writing Ethereum smart contracts is ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"f6a2f99e6fd251a7ed1a5103112bc5baf3f8c55ac563b96d08664f4c53a182db"},{"difficulty":"Hard","points":150,"hint":"The runtime every Ethereum node uses to execute contract bytecode. Three letters.","prompt":"Objective — Smart contracts. The Ethereum Virtual Machine, which executes smart-contract code across the network, is abbreviated ___.\n\nSubmit as flag{abbreviation} (lowercase).","flagHash":"c2e134b552f614af99897237babf59365f37de6d4c7b752995acafec2efe73dd"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m5b","module":5,"title":"Testing & Deploying","category":"Blockchain Coding","levels":[{"difficulty":"Easy","points":50,"hint":"Publish to the network.","prompt":"Objective — Deploying code. Publishing a finished smart contract onto a blockchain network is to ___ it.\n\nSubmit as flag{word} (lowercase).","flagHash":"f1dc979fa097a6d23b52ab5e26dec82f113c9d11881dced5c3b466155e21d299"},{"difficulty":"Medium","points":100,"hint":"Practice network, fake coins.","prompt":"Objective — Deploying code. The practice network where developers test contracts using valueless coins is called a ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"b3b231446277bf8082cf1e95fe9778e72fdcaafaa880d6d8ed2a5fa2746563d8"},{"difficulty":"Hard","points":150,"hint":"Once a contract is on-chain its code can't be edited — you'd have to deploy a new one. One word for that property.","prompt":"Objective — Smart contract risk. Once deployed, a smart contract's code generally cannot be changed. This property is ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"c49b5deed9c8d7547e3b7ce3d4507f6eb826c1faf33c328f87131a1709cc1fbf"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m6a","module":7,"title":"Decentralized Apps","category":"DApps","levels":[{"difficulty":"Easy","points":50,"hint":"Decentralized application.","prompt":"Objective — DApp fundamentals. An application whose backend runs on a blockchain via smart contracts is a ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"80f657643695ce0d2a24cc8be255ca44c369e4316d597a42653e792dc967f761"},{"difficulty":"Medium","points":100,"hint":"Lending, trading, and borrowing built on smart contracts instead of banks. Four letters.","prompt":"Objective — DApp use cases. Financial services (lending, trading) built on blockchain without traditional banks are called ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"0e7ce4039ea026fa071c6f549c97fc636c28b11439c6ac02856020d0378c40d0"},{"difficulty":"Hard","points":150,"hint":"Feeds real-world data on-chain.","prompt":"Objective — DApp architecture. A service that feeds real-world data to a smart contract is called a(n) ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"9afb20edcb5db273f98641cf855adaa62a6ec436c3688c825a73bdf46dfefbdd"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m6b","module":6,"title":"DAOs & Governance","category":"DAOs","levels":[{"difficulty":"Easy","points":50,"hint":"Community-run organization.","prompt":"Objective — DAO fundamentals. A Decentralized Autonomous Organization, run by member votes and code instead of managers, is abbreviated ___.\n\nSubmit as flag{abbreviation} (lowercase).","flagHash":"b75d0ced6d6fcfb0ad15859eca1ace9e49b23261609291cf98b1ea23ce45af3d"},{"difficulty":"Medium","points":100,"hint":"Holding it lets you vote on protocol proposals in a DAO. Two words.","prompt":"Objective — DAO governance. The token that grants members voting power in a DAO is called a ___ ___.\n\nSubmit as flag{two words} (lowercase).","flagHash":"31fa826724732b521120dcdad3cd62ebe84761024ee9b205840d0c74aa974f04"},{"difficulty":"Hard","points":150,"hint":"The mechanism by which distributed nodes agree on one valid version of the ledger. Proof of work and proof of stake are two approaches.","prompt":"Objective — DAO decision-making. The process by which distributed nodes agree on the valid state of the ledger is called ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"1cc4e8c190b1688a8dd844c8f732da7a9a08b324f36eb1afcf9a0fe3a202f7d4"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m7a","module":9,"title":"Project Planning","category":"Class Project","levels":[{"difficulty":"Easy","points":50,"hint":"Explains the project.","prompt":"Objective — Applied problem solving. The document that explains a Web 3.0 project's purpose, technology, and tokenomics is called a ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"b6fdfe6dbbe5ff579a27163c4ba09589d066584358796edbd6103fc308b9abcc"},{"difficulty":"Medium","points":100,"hint":"The real problem it solves.","prompt":"Objective — Tokenomics. The specific real-world problem your project solves is its ___ ___.\n\nSubmit as flag{two words} (lowercase).","flagHash":"05c53fb721bdc68780d3a36933f87293faeb07172fc9e7741e8f688e5c136b1c"},{"difficulty":"Hard","points":150,"hint":"Token supply & incentives.","prompt":"Objective — Tokenomics. The design of a token's supply, distribution, and incentives is called ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"6e50edc26f743932c182177ea8a6320d54fb51497030b70ed8a9a02af706b6a0"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m7b","module":9,"title":"Build & Present","category":"Class Project","levels":[{"difficulty":"Easy","points":50,"hint":"An early working version.","prompt":"Objective — Token/NFT as solution. An early working model of your project used to test the idea is a ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"e7a456f0cf0705f7d03206c9440f6eb224bf0a546f110b00784013ef9eb31297"},{"difficulty":"Medium","points":100,"hint":"The core Web3 property: no single party controls the network or can shut it down.","prompt":"Objective — Web 3 principles. Spreading control across many participants instead of one authority is called ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"4cdeb32a366f7d988d5200cab0cb6b93234de4ccbfb75b0a733a86627f68d7f3"},{"difficulty":"Hard","points":150,"hint":"The smallest version of a product that still delivers value and can be tested with real users. Three words.","prompt":"Objective — Collaborative strategy. The simplest version of a product that still delivers value to users is the ___ ___ ___.\n\nSubmit as flag{three words} (lowercase).","flagHash":"f6da6caa455522fc5d0ca34b68682f23e25b493587d11f198ef8cded22d0a50a"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m8a","module":1,"title":"Ecosystem Terms","category":"Blockchain Basics","levels":[{"difficulty":"Easy","points":50,"hint":"The decentralized web.","prompt":"Objective — Web 3 principles. The name for the decentralized, blockchain-based era of the internet is ___.\n\nSubmit as flag{word} (lowercase, no space).","flagHash":"ef79dff314ff51d6cce3b4829be8a73fa00eebb404f6d7ae3b01cb823d6efd41"},{"difficulty":"Medium","points":100,"hint":"The record of transactions.","prompt":"Objective — Blockchain fundamentals. The shared record of all transactions on a blockchain is called the ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"16a04009c9c5fbdf408cdcbce2e16ee2f6132ec0b121366b7e1717e4aabb97d5"},{"difficulty":"Hard","points":150,"hint":"Validators lock up coins.","prompt":"Objective — Consensus mechanisms. The energy-efficient consensus where validators lock up coins as collateral is called ___ ___ ___.\n\nSubmit as flag{three words} (lowercase).","flagHash":"2a6b5e5cc189aec303cf9b24132571944977d476d90249e8868a0a35af70891f"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m8b","module":2,"title":"Risks & Safety","category":"Cryptocurrencies","levels":[{"difficulty":"Easy","points":50,"hint":"A fraud to avoid.","prompt":"Objective — Wallet security. A fraudulent scheme designed to steal crypto or keys is a ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"fa1964123faa234e3ad0c7c8da65f0cf85e900c76e1488c7043b1f69926979c1"},{"difficulty":"Medium","points":100,"hint":"Devs vanish with the money.","prompt":"Objective — Smart contract risk. A scam where creators abandon a project and run off with investors' funds is a ___ ___.\n\nSubmit as flag{two words} (lowercase).","flagHash":"07674a056eaacf673c4d6e71db3254ead7f5aee1e532b16694b95d38fbf39cbe"},{"difficulty":"Hard","points":150,"hint":"What you pay the network to include and execute your transaction. It rises when the network is busy. Two words.","prompt":"Objective — Gas fees. The charge paid to process a transaction on the network is the ___ ___.\n\nSubmit as flag{two words} (lowercase).","flagHash":"582c94eddd908816ff0b7eaaa55df49d419d8d8bfec30a36f82530048eb97401"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m1-parts","module":1,"type":"match","title":"Parts of a Block","category":"Blockchain Basics","points":150,"intro":"Objective — Blockchain fundamentals. Match each part of a block to what it holds. Tap a part, then tap its meaning.","pairs":[{"left":"Hash","right":"This block's unique fingerprint"},{"left":"Previous hash","right":"Links to the block before it"},{"left":"Transactions","right":"The data recorded in the block"},{"left":"Nonce","right":"Number miners change to solve the puzzle"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m1-mine","module":1,"type":"order","title":"Add a Block to the Chain","category":"Blockchain Basics","points":150,"intro":"Objective — Consensus mechanisms. Order the steps to add a new block using proof of work, first to last.","steps":["Collect pending transactions","Bundle them into a candidate block","Miners race to solve the hash puzzle","The network verifies the winning block","The block is added to every copy of the chain"]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m1-cf","module":1,"type":"match","title":"Centralized or Decentralized?","category":"Blockchain Basics","points":150,"intro":"Objective — Centralization vs decentralization. Sort each system. Tap the example, then tap its type.","pairs":[{"left":"A single bank's database","right":"Centralized"},{"left":"The Bitcoin network","right":"Decentralized"},{"left":"One company's server","right":"Centralized"},{"left":"Thousands of nodes sharing a ledger","right":"Decentralized"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m2-keys","module":4,"type":"match","title":"Share It or Hide It?","category":"Digital Wallets","points":150,"intro":"Objective — Wallet security. Sort each item by whether it is safe to share. Tap the item, then tap the category.","pairs":[{"left":"Public address","right":"Safe to share"},{"left":"Private key","right":"Keep secret"},{"left":"Seed phrase","right":"Keep secret"},{"left":"Wallet's public key","right":"Safe to share"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m2-send","module":4,"type":"order","title":"Send a Transaction","category":"Digital Wallets","points":150,"intro":"Objective — Wallet transactions. Order the steps to send crypto from your wallet, first to last.","steps":["Enter the recipient's address","Enter the amount","Sign with your private key","Broadcast to the network","Wait for confirmation on-chain"]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m2-wallets","module":4,"type":"match","title":"Hot vs Cold Wallets","category":"Digital Wallets","points":150,"intro":"Objective — Wallet types. Match each wallet to its trait. Tap the wallet, then tap the trait.","pairs":[{"left":"Hot wallet","right":"Connected to the internet, convenient"},{"left":"Cold wallet","right":"Kept offline, most secure"},{"left":"Hardware wallet","right":"A physical cold-storage device"},{"left":"Exchange wallet","right":"Custodial — the platform holds your keys"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m3-types","module":2,"type":"match","title":"Match the Token Type","category":"Cryptocurrencies","points":150,"intro":"Objective — Coins & tokens. Match each token to its description. Tap a token, then tap its description.","pairs":[{"left":"Stablecoin","right":"Pegged to a steady value like USD"},{"left":"Governance token","right":"Grants voting power in a DAO"},{"left":"Utility token","right":"Used to access a product or service"},{"left":"NFT","right":"Represents a unique item"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m3-ff","module":2,"type":"match","title":"Fungible or Non-Fungible?","category":"Cryptocurrencies","points":150,"intro":"Objective — Fungibility. Sort each item. Tap the item, then tap the category.","pairs":[{"left":"One dollar bill for another","right":"Fungible"},{"left":"A specific numbered trading card","right":"Non-Fungible"},{"left":"One Bitcoin for another Bitcoin","right":"Fungible"},{"left":"A unique piece of digital art","right":"Non-Fungible"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m3-fee","module":2,"type":"order","title":"How a Gas Fee Works","category":"Cryptocurrencies","points":150,"intro":"Objective — Gas fees. Order what happens with gas on a transaction, first to last.","steps":["You submit a transaction","The network estimates the gas needed","You pay the gas fee","Validators process the transaction","The transaction is confirmed"]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m4-mint","module":3,"type":"order","title":"Mint an NFT","category":"NFTs","points":150,"intro":"Objective — Creating an NFT. Order the steps to mint an NFT, first to last.","steps":["Create the digital asset","Upload the media and metadata","Connect your wallet to the platform","Pay the gas fee to mint","The NFT is recorded on-chain"]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m4-terms","module":3,"type":"match","title":"Match the NFT Term","category":"NFTs","points":150,"intro":"Objective — NFT fundamentals. Match each term to its meaning. Tap a term, then tap its meaning.","pairs":[{"left":"Minting","right":"Publishing an NFT on-chain"},{"left":"Metadata","right":"The traits and media link"},{"left":"Marketplace","right":"Where NFTs are bought and sold"},{"left":"Royalty","right":"A cut the creator earns on resale"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m4-myth","module":3,"type":"match","title":"NFT: True or False?","category":"NFTs","points":150,"intro":"Objective — NFT characteristics. Sort each statement. Tap the statement, then tap True or False.","pairs":[{"left":"An NFT proves on-chain ownership of a token","right":"True"},{"left":"Owning an NFT always gives full copyright","right":"False"},{"left":"Each NFT has a unique identifier","right":"True"},{"left":"NFTs are interchangeable one-for-one","right":"False"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m5-contract","module":5,"type":"match","title":"Smart Contract Concepts","category":"Blockchain Coding","points":150,"intro":"Objective — Smart contracts. Match each term to its meaning. Tap a term, then tap its meaning.","pairs":[{"left":"Smart contract","right":"Self-executing code on the chain"},{"left":"Solidity","right":"Ethereum's contract language"},{"left":"EVM","right":"Runs the contract code"},{"left":"Deploy","right":"Publish the contract to the network"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m5-flow","module":5,"type":"order","title":"Build & Deploy a Contract","category":"Blockchain Coding","points":150,"intro":"Objective — Deploying code. Order the steps to build and deploy a smart contract, first to last.","steps":["Write the contract in Solidity","Compile the code","Test it on a testnet","Deploy it to the mainnet","Users interact with it via a dApp"]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m5-trigger","module":5,"type":"match","title":"What Triggers the Code?","category":"Blockchain Coding","points":150,"intro":"Objective — Smart contracts. Match each concept to its role. Tap the concept, then tap its role.","pairs":[{"left":"Condition met","right":"Causes the contract to execute"},{"left":"Gas","right":"Pays for the computation"},{"left":"Function call","right":"Runs a specific contract action"},{"left":"Immutable","right":"Code can't change after deploy"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m6-match","module":7,"type":"match","title":"DApp & DAO Terms","category":"DApps","points":150,"intro":"Objective — DApp fundamentals. Match each term to its meaning. Tap a term, then tap its meaning.","pairs":[{"left":"dApp","right":"App with a blockchain backend"},{"left":"DeFi","right":"Finance without traditional banks"},{"left":"DAO","right":"Community run by votes and code"},{"left":"Oracle","right":"Feeds real-world data on-chain"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m6-vote","module":6,"type":"order","title":"How a DAO Vote Works","category":"DAOs","points":150,"intro":"Objective — DAO governance. Order how a DAO makes a decision, first to last.","steps":["A member submits a proposal","Token holders review it","Members vote with governance tokens","Votes are tallied on-chain","The winning outcome executes automatically"]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m6-defi","module":7,"type":"match","title":"TradFi vs DeFi","category":"DApps","points":150,"intro":"Objective — DeFi & tokenization. Sort each trait. Tap the trait, then tap the category.","pairs":[{"left":"A bank approves your loan","right":"Traditional Finance"},{"left":"A smart contract lends automatically","right":"DeFi"},{"left":"A central company holds funds","right":"Traditional Finance"},{"left":"Code and collateral replace the middleman","right":"DeFi"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m7-plan","module":9,"type":"order","title":"Plan Your Web3 Project","category":"Class Project","points":150,"intro":"Objective — Applied problem solving. Order the stages of planning a Web 3.0 project, first to last.","steps":["Identify a problem to solve","Define the use case","Design the tokenomics","Build a prototype","Present the whitepaper"]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m7-match","module":9,"type":"match","title":"Match the Project Piece","category":"Class Project","points":150,"intro":"Objective — Applied problem solving. Match each deliverable to what it is. Tap a piece, then tap its meaning.","pairs":[{"left":"Whitepaper","right":"Explains purpose and tech"},{"left":"Tokenomics","right":"Supply and incentive design"},{"left":"Prototype","right":"Early working version"},{"left":"Use case","right":"The problem it solves"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m7-good","module":9,"type":"match","title":"Strong or Weak Idea?","category":"Class Project","points":150,"intro":"Objective — Collaborative strategy. Sort each project idea. Tap the idea, then tap the label.","pairs":[{"left":"Solves a real problem decentralization helps","right":"Strong"},{"left":"Adds blockchain for no clear reason","right":"Weak"},{"left":"Has clear users and tokenomics","right":"Strong"},{"left":"Copies another project with no improvement","right":"Weak"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m8-consensus","module":1,"type":"match","title":"PoW vs PoS","category":"Blockchain Basics","points":150,"intro":"Objective — Proof of work vs proof of stake. Sort each trait to its mechanism. Tap the trait, then tap the mechanism.","pairs":[{"left":"Miners solve puzzles with computing power","right":"Proof of Work"},{"left":"Validators lock up coins as collateral","right":"Proof of Stake"},{"left":"Very energy intensive","right":"Proof of Work"},{"left":"More energy efficient","right":"Proof of Stake"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m8-safe","module":4,"type":"match","title":"Safe or Scam?","category":"Digital Wallets","points":150,"intro":"Objective — Wallet security. Sort each action. Tap the action, then tap the label.","pairs":[{"left":"Someone DMs asking for your seed phrase","right":"Scam"},{"left":"Storing your seed phrase offline yourself","right":"Safe"},{"left":"A site promising guaranteed 100x returns","right":"Scam"},{"left":"Verifying a contract before you sign","right":"Safe"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m8-glossary","module":1,"type":"match","title":"Web3 Glossary Match","category":"Blockchain Basics","points":150,"intro":"Objective — Web 3 principles. Match each term to its meaning. Tap a term, then tap its meaning.","pairs":[{"left":"Ledger","right":"The shared record of transactions"},{"left":"Gas fee","right":"Cost to process a transaction"},{"left":"Rug pull","right":"Creators flee with the funds"},{"left":"Web3","right":"The decentralized internet era"}]});
...
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m2-vocab","module":4,"type":"vocab","title":"Vocabulary Recall","category":"Vocabulary","bias":["wallet","private key","public key","seed phrase","address","cold wallet","hot wallet","custody","signature"],"hardMode":"unscramble"});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m3-vocab","module":2,"type":"vocab","title":"Vocabulary Recall","category":"Vocabulary","bias":["token","coin","gas","stablecoin","fungible","cryptocurrency","erc","utility","supply"],"hardMode":"speedmatch"});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m4-vocab","module":3,"type":"vocab","title":"Vocabulary Recall","category":"Vocabulary","bias":["nft","non-fungible","mint","minting","metadata","ownership","royalty","ipfs","collectible"],"hardMode":"blitz"});
...
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m7-vocab","module":9,"type":"vocab","title":"Vocabulary Recall","category":"Vocabulary","bias":["whitepaper","tokenomics","prototype","use case","project","mvp","decentralization","roadmap"],"hardMode":"rapid"});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-m8-vocab","module":8,"type":"vocab","title":"Vocabulary Recall","category":"Vocabulary","bias":["regulation","compliance","jurisdiction","liability","privacy","transparency","consent","audit","kyc","ico"],"hardMode":"cipher"});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-web-eras","module":1,"title":"The Web Through Time","category":"Blockchain Basics","levels":[{"difficulty":"Easy","points":50,"hint":"Whose stuff is it?","prompt":"Objective — Web evolution. Web 1.0 let you read and Web 2.0 let you read and write. Web 3.0 adds a third verb — read, write, and ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"83da5478e43d674f4d68013b2d0447eef7bcbecc4ed7943538fcdfcf6c1596e9"},{"difficulty":"Medium","points":100,"hint":"Not rental.","prompt":"Objective — Web 3 principles. In Web 2.0 the platform holds your data and accounts. The Web 3.0 principle that you hold them yourself is called user ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"d1e610099b17a5b008e801609d52f09d63d7f7a600bc1fe6c0666aa991b578a2"},{"difficulty":"Hard","points":150,"hint":"How goods reach a store.","prompt":"Objective — Blockchain use cases. Tracking a product from farm to shelf so every handoff is verifiable is the ___ ___ use case.\n\nSubmit as flag{two words} (lowercase).","flagHash":"6f3c7a3e988f6873a007d952d166de07242625a33eb56cdbc1e692036b57d931"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-nft-law","module":3,"title":"Law, Tax & Rights","category":"NFTs","levels":[{"difficulty":"Easy","points":50,"hint":"The opposite of a loss.","prompt":"Objective — NFT law & regulation. Profit made from selling an NFT for more than you paid is generally taxed as a capital ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"74ef61006fade5ab2dca75568fec3acd8ffbe01ca6df05483a6dd61d580c0301"},{"difficulty":"Medium","points":100,"hint":"The right to reproduce it.","prompt":"Objective — NFT law & regulation. Buying an NFT of an artwork does not transfer the artist's underlying ___ unless the sale says so.\n\nSubmit as flag{word} (lowercase).","flagHash":"7b5d1a4db073d1358859d752555b4ef945495a103b90146d503aff0e3f751a55"},{"difficulty":"Hard","points":150,"hint":"Musicians get these too.","prompt":"Objective — NFT law & regulation. A percentage paid to the original creator on every later resale, written into the contract, is a ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"72ee939aa83c28c312dbc326c8c3f0ccc03e03988d2cfb42f920a3f78318b340"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-wallet-connect","module":4,"title":"Associating & Connecting","category":"Digital Wallets","levels":[{"difficulty":"Easy","points":50,"hint":"Opt in to hold it.","prompt":"Objective — Token association. On some networks a wallet must first ___ with a token before it is allowed to receive it.\n\nSubmit as flag{word} (lowercase).","flagHash":"7b542b06a9070ac516a2d5864e8b65fb60a02cb85b1181c8f124b677fb6f0e3f"},{"difficulty":"Medium","points":100,"hint":"You do this on paper too.","prompt":"Objective — Connecting wallets. Approving an action with your private key, without ever revealing that key, produces a digital ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"223e9978a3e86c5d5e7a0f59dde9606722740e63f3953b3394fcef94c2ac2a22"},{"difficulty":"Hard","points":150,"hint":"A spending limit you granted.","prompt":"Objective — Connecting wallets. A standing permission that lets a DApp spend tokens from your wallet, and should be revoked when unused, is an ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"0c89a83816dd5a3742a0e484fedff8e0ababecbdc7358835b9d7ead507d3f63f"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-token-keys","module":5,"title":"Token Keys & Control","category":"Blockchain Coding","levels":[{"difficulty":"Easy","points":50,"hint":"It controls how many exist.","prompt":"Objective — Token keys. The key that allows new units of a token to be minted after it is created is the ___ ___.\n\nSubmit as flag{two words} (lowercase).","flagHash":"450b5ba88ea91bbc7357b3431d45883ffc44c05e32fdf3aa97a8b77021a087ad"},{"difficulty":"Medium","points":100,"hint":"It puts an account on ice.","prompt":"Objective — Token keys. The key that lets an administrator block one account from transferring a token is the ___ ___.\n\nSubmit as flag{two words} (lowercase).","flagHash":"b3644cfbd4aa880c685cd029294f5c6e24e85b626970c5267897950ca945166b"},{"difficulty":"Hard","points":150,"hint":"Locked forever.","prompt":"Objective — Token keys. Setting a token's keys to null so nobody can ever alter it again makes the token ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"c49b5deed9c8d7547e3b7ce3d4507f6eb826c1faf33c328f87131a1709cc1fbf"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-dao-apply","module":6,"title":"Proposals & Quorum","category":"DAOs","levels":[{"difficulty":"Easy","points":50,"hint":"Code that executes itself.","prompt":"Objective — DAO fundamentals. The rule set that runs a DAO is enforced by code rather than managers — it lives in a smart ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"86f0e6b100c80f230ec8664619cdc3e89df1184a63364eec30b41d2b22977275"},{"difficulty":"Medium","points":100,"hint":"You put it forward.","prompt":"Objective — DAO governance. A formal suggestion a member submits for the whole DAO to vote on is called a ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"ab2e3b1abd16fc78a148130aebf6c0f862c09c02ff3a0e0b38b4d745232aee51"},{"difficulty":"Hard","points":150,"hint":"Enough people showed up.","prompt":"Objective — DAO governance. The minimum participation required before a DAO vote counts as valid is called ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"163ca7ccb1cb986a15834093c6cad5e93ed34d6506f73d78063517dda80b8ed5"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-dao-ethics","module":6,"title":"Power, Law & Liability","category":"DAOs","levels":[{"difficulty":"Easy","points":50,"hint":"The thing DAOs try to avoid.","prompt":"Objective — DAO ethics. When one member holds enough governance tokens to decide every vote alone, voting power has become ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"a33cb01ce099dce15be3b80948e56a9110c4b00781d19ec0e4127b71fb5fc781"},{"difficulty":"Medium","points":100,"hint":"Who pays if it goes wrong?","prompt":"Objective — DAO legal considerations. Because most DAOs are not registered companies, members face uncertainty about personal legal ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"1c2e0d48dc138916384bedd521c41cb3e7f0c4d7f4e0d8181df9971e69d484b2"},{"difficulty":"Hard","points":150,"hint":"Three letters.","prompt":"Objective — DAO legal considerations. Some U.S. states now let a DAO register as a limited liability company, abbreviated ___.\n\nSubmit as flag{abbreviation} (lowercase).","flagHash":"bd9b119fdb31b038b036e009527cb9c953fb5430f7128e3070d66ce01da9563b"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-dapp-traits","module":7,"title":"Anatomy of a DApp","category":"DApps","levels":[{"difficulty":"Easy","points":50,"hint":"Opposite of backend.","prompt":"Objective — DApp characteristics. The part of a DApp that users actually see and click in the browser is the ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"cd79bb5b19ff875ebdf3b084d59c7b52b9cb61e4a667106da7b18eedd601646e"},{"difficulty":"Medium","points":100,"hint":"Where centralized apps live.","prompt":"Objective — DApp architecture. Unlike a Web 2.0 app, a DApp has no single ___ that one company can switch off.\n\nSubmit as flag{word} (lowercase).","flagHash":"cb69d6bc363a9bbe3c99e1d657cebdfe9349cdf02e28dc74db6eed9e62c172c0"},{"difficulty":"Hard","points":150,"hint":"Make it a token.","prompt":"Objective — DApp economics. Turning a real asset or right into a tradable token on a blockchain is called ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"50b48427e8d463f8708e9cca41428b28096bd874383a1ca9f806761962436e46"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-dapp-risk","module":7,"title":"Security & Jurisdiction","category":"DApps","levels":[{"difficulty":"Easy","points":50,"hint":"Accountants do these too.","prompt":"Objective — DApp security. A review of a smart contract's code by outside experts before launch is called an ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"de298d79fd1cf82ff02e6e7764b36cc280d8e7dbde822b187a46ef8cbab47367"},{"difficulty":"Medium","points":100,"hint":"It goes back in.","prompt":"Objective — DApp security. An attack that re-enters a contract's function repeatedly before it updates its balance is a ___ attack.\n\nSubmit as flag{word} (lowercase).","flagHash":"686976d7f95b7b49a145f8c5208a035ebec5d0926b9e65132b52ac7ae466ca28"},{"difficulty":"Hard","points":150,"hint":"Which court has authority.","prompt":"Objective — DApp legal considerations. Because a DApp runs everywhere at once, the hardest legal question is whose law applies — an issue of ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"e0edc02d0e841a72dcf1cdfa56a53735450a12aa5133093b082d150806adcf1b"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-law-frameworks","module":8,"title":"Regulators & Rules","category":"Legal & Ethical","levels":[{"difficulty":"Easy","points":50,"hint":"Three letters.","prompt":"Objective — Regulatory frameworks. The U.S. agency that decides whether a token counts as a security is the ___.\n\nSubmit as flag{abbreviation} (lowercase).","flagHash":"f035b6008ad081d0d59cfccef5bdd16c00c5d6cb6bce0e73d6896ea2339ddb67"},{"difficulty":"Medium","points":100,"hint":"Three letters.","prompt":"Objective — Legal implications of tokenization. A fundraise that sells a brand-new token to the public to raise money is an initial coin offering, abbreviated ___.\n\nSubmit as flag{abbreviation} (lowercase).","flagHash":"8a2e628d4736786a4729e228b80bb841f09a5e9739dc4576dfe89f3d9bff0e33"},{"difficulty":"Hard","points":150,"hint":"Know Your ___.","prompt":"Objective — Regulatory frameworks. Rules requiring an exchange to verify who its customers are go by the abbreviation ___.\n\nSubmit as flag{abbreviation} (lowercase).","flagHash":"ac4809b49c2ed301d48fb6f3ca5a0ee4924d1eaad022fba145a2b7fc2f98e8d1"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-ethics-dilemmas","module":8,"title":"Permanence & Power","category":"Legal & Ethical","levels":[{"difficulty":"Easy","points":50,"hint":"Removed for good.","prompt":"Objective — Data privacy & ownership. Because a public blockchain is permanent, personal data written onto it can never truly be ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"43fb9c726ae17022b1495ec3b54457966820007457b89ec261055e306b58afa0"},{"difficulty":"Medium","points":100,"hint":"You can see through it.","prompt":"Objective — Ethical dilemmas. Every transaction being publicly viewable by anyone gives a blockchain its ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"7232fbfbd2e85bf3cc2e1df28942d220cc312ca3ff4c8309c5ddf9cdcb57e738"},{"difficulty":"Hard","points":150,"hint":"Who ends up with power.","prompt":"Objective — Algorithmic bias. A consensus design that grants more influence to whoever already holds more coins risks concentrating ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"202680ab36aac4677f88bf1828833217628b4eb78e28e5affab491816ebd210d"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-adopt","module":8,"title":"Responsible Adoption","category":"Legal & Ethical","levels":[{"difficulty":"Easy","points":50,"hint":"Permission that is real.","prompt":"Objective — Responsible adoption. Explaining risks in plain language so a user genuinely agrees is called informed ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"0d09c7d18a59c1c61f2d831fd59ae599a65798399f6425ace38da2e14858bd94"},{"difficulty":"Medium","points":100,"hint":"Keep it small.","prompt":"Objective — User-centric design. Collecting only the data you actually need, and no more, is called data ___.\n\nSubmit as flag{word} (lowercase).","flagHash":"37422175849d3d706b90c336948f94e5762758823c87bbadfc7f69b5d4aba64e"},{"difficulty":"Hard","points":150,"hint":"You learn nothing extra.","prompt":"Objective — Responsible adoption. Cryptography letting a user prove something is true without revealing the data behind it is a ___ ___ proof.\n\nSubmit as flag{two words} (lowercase).","flagHash":"e1ae1e8b275c3fb78be818cfbc9636eef8486c4a179a5fd3151bfcf8bcf3d96a"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-dao-tradeoffs","module":6,"type":"match","title":"DAO: Upside or Problem?","category":"DAOs","points":150,"intro":"Objective — DAO benefits & challenges. Sort each trait of a DAO. Tap the trait, then tap the label.","pairs":[{"left":"Anyone can read every decision","right":"Benefit"},{"left":"Votes can be slow to reach quorum","right":"Challenge"},{"left":"No manager can overrule the members","right":"Benefit"},{"left":"Whoever buys the most tokens gains the most say","right":"Challenge"},{"left":"Rules run automatically as written","right":"Benefit"},{"left":"A bug in the code is a bug in the rules","right":"Challenge"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-dao-real","module":6,"type":"match","title":"What Is This DAO For?","category":"DAOs","points":150,"intro":"Objective — DAO applications. Match each real-world DAO to what it does. Tap the DAO, then tap its purpose.","pairs":[{"left":"Protocol DAO","right":"Governs how a DeFi platform's rules change"},{"left":"Grants DAO","right":"Votes on funding proposals from builders"},{"left":"Collector DAO","right":"Pools member money to buy assets together"},{"left":"Social DAO","right":"Runs a member community and its shared treasury"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-dapp-vs","module":7,"type":"match","title":"DApp or Traditional App?","category":"DApps","points":150,"intro":"Objective — DApps vs centralized apps. Sort each trait. Tap the trait, then tap the category.","pairs":[{"left":"One company controls the database","right":"Traditional app"},{"left":"Backend logic runs in smart contracts","right":"DApp"},{"left":"Can be taken offline by its owner","right":"Traditional app"},{"left":"Users sign actions with their own keys","right":"DApp"},{"left":"Password reset by support staff","right":"Traditional app"},{"left":"Code is public and verifiable","right":"DApp"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-legal-sort","module":8,"type":"match","title":"Legal Question or Ethical Question?","category":"Legal & Ethical","points":150,"intro":"Objective — Legal & ethical frameworks. Sort each question. Tap the question, then tap the category.","pairs":[{"left":"Does this token count as a security?","right":"Legal"},{"left":"Should we launch knowing most buyers will lose money?","right":"Ethical"},{"left":"Which country's tax rules apply to this sale?","right":"Legal"},{"left":"Is it right to keep data on-chain forever?","right":"Ethical"},{"left":"Must we verify our customers' identities?","right":"Legal"},{"left":"Who is excluded if a wallet is the only way in?","right":"Ethical"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-ethics-spot","module":8,"type":"match","title":"Responsible or Reckless?","category":"Legal & Ethical","points":150,"intro":"Objective — Responsible adoption. Sort each choice a Web 3.0 project could make. Tap the choice, then tap the label.","pairs":[{"left":"Publishing an outside audit before launch","right":"Responsible"},{"left":"Promising guaranteed returns to buyers","right":"Reckless"},{"left":"Writing risks in plain language up front","right":"Responsible"},{"left":"Storing users' legal names on-chain","right":"Reckless"},{"left":"Letting users export and leave at any time","right":"Responsible"},{"left":"Hiding who controls the admin keys","right":"Reckless"}]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-adopt-order","module":8,"type":"order","title":"Launch It the Right Way","category":"Legal & Ethical","points":150,"intro":"Objective — Responsible adoption. Order the steps to release a Web 3.0 project responsibly, first to last.","steps":["Identify who the project affects and how","Check which laws and regulations apply","Have the contract code audited by outsiders","Publish the risks in plain language","Test publicly on a testnet","Launch, then keep monitoring and disclosing"]});
window.COURSE_CONFIG.web3.ctf.challenges.push({"id":"w3-dapp-vocab","module":7,"type":"vocab","title":"Vocabulary Recall","category":"Vocabulary","bias":["dapp","smart contract","frontend","oracle","defi","tokenization","audit","jurisdiction","reentrancy","gas"],"hardMode":"rapid"});
